  ...
  icon: weather.daily.weathercode ? weatherCodeToIcon[weather.daily.weathercode[0]] : sunny,
   ...
   return (
      ...
      <div className='pb-10 flex flex-col media:justify-center media:flex-row media:gap-6 media:items-center'>
        <div>
            {weather && (
            <div className="bg-[url('./src/assets/bg-today-small.svg')] media:bg-[url('./src/assets/bg-today-large.svg')] bg-no-repeat bg-cover m-3 flex flex-col py-10 text-white text-center media:flex-row media:justify-between media:items-center media:px-6 media:py-14 media:w-[100%] ">
